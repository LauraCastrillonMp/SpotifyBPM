  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#1DB954] text-white">
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">Analyze your Spotify playlists in seconds.</p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Recommendations</h3>
                      <p className="text-gray-500 dark:text-gray-400">Get song recommendations based on your mood.</p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 SpotifyBPM. All rights reserved.</p>
